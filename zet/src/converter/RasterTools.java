...
public final class RasterTools {
	 ...
	 */
	public final static <T extends RoomRasterSquare> List<T> getSquaresAlongEdge( ds.z.Edge edge, RoomRaster<T> raster ) {
	 ...
	 */
	public final static <T extends RoomRasterSquare> List<T> getSquaresAboveEdge( ds.z.Edge edge, RoomRaster<T> raster ) {
	 ...
	 * the y-axis, the returned list is empty.
	 */
	public final static <T extends RoomRasterSquare> List<T> getSquaresBelowEdge( ds.z.Edge edge, RoomRaster<T> raster ) {
		int rasterX1 = RasterTools.polyCoordToRasterCoord( edge.boundLeft(), raster.getXOffset(), raster );
		int rasterX2 = RasterTools.polyCoordToRasterCoord( edge.boundRight(), raster.getXOffset(), raster );
	 ...
	 */
	public final static <T extends RoomRasterSquare> List<T> getSquaresLeftOfEdge( ds.z.Edge edge, RoomRaster<T> raster ) {
		int rasterX1 = RasterTools.polyCoordToRasterCoord( edge.boundLeft(), raster.getXOffset(), raster );
		int rasterX2 = RasterTools.polyCoordToRasterCoord( edge.boundRight(), raster.getXOffset(), raster );
	 ...
	 * the x-axis, the returned list is empty.
	 */
	public final static <T extends RoomRasterSquare> List<T> getSquaresRightOfEdge( ds.z.Edge edge, RoomRaster<T> raster ) {
		int rasterX1 = RasterTools.polyCoordToRasterCoord( edge.boundLeft(), raster.getXOffset(), raster );
		int rasterX2 = RasterTools.polyCoordToRasterCoord( edge.boundRight(), raster.getXOffset(), raster );
