 ...
 * a QuickTime movie.
 *
 *@author Sun Utilities
 */
public class JpegImagesToQuicktime implements ControllerListener, DataSinkListener {

    public static void make(int width, int height, int frameRate, String fileName, int startNumber, int endNumber) {
