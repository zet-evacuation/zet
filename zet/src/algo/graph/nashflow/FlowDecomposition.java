...
public class FlowDecomposition {
    ...
    private DoubleMap<Edge> flowValues;
    private Node source;
    private Node sink;
    ...
    public FlowDecomposition(List<Node> nodes, HashSet<Edge> usedEdges, HashMap<Edge,Edge> newEdgeToOrigEdge, DoubleMap<Edge> flows, Node sourceNode, Node sinkNode, double initRate) {
        source = sourceNode;
        sink = sinkNode;
        ...
        flowValues = new DoubleMap<Edge>(usedEdges.size());
        double flowvalue;
