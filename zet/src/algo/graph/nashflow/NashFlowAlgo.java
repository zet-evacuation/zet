...
public class NashFlowAlgo extends Algorithm<NashFlowProblem,NashFlow> {
    ...
    private List<HashMap<List<Edge>,Double>> pathFlowSizeList;
     ...
     private void initializeDatastructures() {
        OutFlowValueVector = new Vector< double[] >();
        InFlowValueVector = new Vector< double[] >();
        NodelabelVector = new Vector< DoubleMap<Node> >();
        ThetaVector = new Vector<Double>();
        usedPaths = new Vector<List<List<Edge>>>();
        usedEdgesCountVector = new Vector<HashMap<Edge,Integer>>();
        edgeToUsedPathsVector = new Vector<HashMap<Edge,List<List<Edge>>>>();
        pathFlowSizeList = new ArrayList<HashMap<List<Edge>,Double>>();        
     }
     ...
     public Vector<DoubleMap<Node>> getNodelabelVector() {
     ...
     private double computeAlphaForE_1(HashMap<Edge,Double> transitMap, DoubleMap<Node> nodelabels, 
             DoubleMap<Node> thinflowNodelabels, ArrayList<Edge> E_1) throws Exception {       
          ...
          for(Edge e: E_1) {
              ...
              else throw new Exception("division by zero in computeAlpha");
    ...
    private double computeAlphaForGminusGtheta(HashMap<Edge,Double> transitMap, DoubleMap<Node> nodelabels, 
               DoubleMap<Node> thinflowNodelabels, ArrayList<Edge> E_GminusGtheta) throws Exception {
    ...
    private double computeAlpha(HashMap<Edge,Double> transitMap, DoubleMap<Node> nlabel, 
            DoubleMap<Node> thinlabel, ArrayList<Edge> E1, ArrayList<Edge> GminusGtheta) throws Exception {
    ...
    public void runNashFlow(NashFlowProblem nashprob) throws Exception {
         ...
         DoubleMap<Node> nodelabels = new DoubleMap(workingGraph.numberOfNodes());
         DoubleMap<Edge> waitingtimes = new DoubleMap(workingGraph.numberOfEdges()); 
         ...
         /*convert (TransitTimes) DoubleMap to (transitMap) Java map*/
          ...
          DoubleMap spNetworkCapacities = new DoubleMap(spNetwork.numberOfEdges());
          DoubleMap thinflowCapacities = new DoubleMap(spNetwork.numberOfEdges()+E_1.size());
          ...
          DoubleMap<Edge> thinflowFlowvalues = null;
          DoubleMap<Node> thinflowNodelabels = null;
          ...
          DoubleMap<Node> nodeDem = new DoubleMap(tfprob.getNodeDemands());
          ...
          NodelabelVector.add(iteration, new DoubleMap(nodelabels));
    ...
    public void runNashFlowWithMultipleSources(NashFlowProblem nashprob) throws Exception {
     ...
     private double[] computeInFlowValues(DynamicNetwork spNetwork,DoubleMap<Edge> thinflowValues, DoubleMap<Node> thinflowNodelabels) {
     ...
     private double[] computeOutFlowValues(DynamicNetwork spNetwork, DoubleMap<Edge> thinflowValues, DoubleMap<Node> thinflowNodelabels) {
     ...
     private double NodeOutFlowValue(Node n, ArrayList<Edge> edgelist, DoubleMap<Edge> flowvalues) {
         double flow = 0.0;
         for(Edge e: edgelist) {
