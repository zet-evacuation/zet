...
/**
 * The {@code @link StaticPathFlow} class represents the static flow on one
...
public class StaticPathFlow implements Iterable<Edge> {
  ...
  /**
   * Returns the edges of the path belonging to this {@code StaticPathFlow}. If
   * no path is set, {@code null} is returned.
   *
   * @return the edges of the path belonging to this {@code StaticPathFlow}. or
   ...
   * {@code StaticPathFlow}. If no path is set, {@code null} is returned.
   *
   ...
   * {@code StaticPathFlow}. With the iterator one can iterate comfortable
   * through all edges.
   *
  ...
  /**
   * Returns whether an object is equal to this {@code StaticPathFlow}. The
   * result is {@code true} if and only if the argument is not null and is a
   * {@code StaticPathFlow} object having the same amount and containing a path
   * equal to the path in this {@code StaticPathFlow}.
   *
  ...
  /**
   * Returns the hash code of this {@code StaticPathFlow}. The hash code is
   * calculated by computing the arithmetic mean of the amount and the hash code
   * of the underlying {@link StaticPath} of this {@code StaticPathFlow}.
  ...
  /**
   * Clones this {@code StaticPathFlow} by cloning the underlying
   * {@link StaticPath} and creating a new {@code StaticPathFlow} with the clone
   * and the same {@code amount} as this {@code StaticPathFlow}.
   *
