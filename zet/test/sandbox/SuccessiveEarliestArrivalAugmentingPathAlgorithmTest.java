 ...
 * @author Martin
 */
public class SuccessiveEarliestArrivalAugmentingPathAlgorithmTest {

    public SuccessiveEarliestArrivalAugmentingPathAlgorithmTest() {
    }
    ...
    public void runAlgorithm() {
        ...
        //EarliestArrivalFlowProblem problem = new EarliestArrivalFlowProblem(edgeCapacities, network, nodeCapacities, sink, source, 5, transitTimes);
        ...
        algo.run();
        System.out.println(algo.getSolution());
        drn.augmentPath(algo.getSolution());
        System.out.println(drn.capacities());
        algo = new EarliestArrivalAugmentingPathAlgorithm();
        algo.setProblem(eaapp);
        algo.run();        
        System.out.println(algo.getSolution());*/        
    }
