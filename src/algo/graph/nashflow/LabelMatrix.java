...
public class LabelMatrix {
   ...
   private DoubleMap<Edge> edgeCapacities;
   private DoubleMap<Node> nodeDemands;
           
    
    public LabelMatrix(NodePartition nodePart, List<Edge> edgeSet, List<Edge> E_1, DoubleMap<Edge> edgeCap, 
            DoubleMap<Node> nodedemands) {
