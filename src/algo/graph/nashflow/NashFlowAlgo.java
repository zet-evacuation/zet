...
public class NashFlowAlgo extends AbstractAlgorithm<NashFlowProblem, NashFlow> {
    ...
    private void computeUsedEdgesPathsMaps(ListSequence<Edge> edges, List<List<Edge>> usedPaths) {
        HashMap<Edge, Integer> usedEdgesCount = new HashMap<>();
        HashMap<Edge, List<List<Edge>>> edgeToUsedPaths = new HashMap<>();
        for (Edge edge : edges) {
            usedEdgesCount.put(edge, 0);
            edgeToUsedPaths.put(edge, new ArrayList<>());
        }
    ...
    public void runNashFlow(NashFlowProblem nashprob) throws Exception {
        ...
        while (true) {
            ...
            HashMap<Edge, Node> identMap = new HashMap<>();
            /*map to identify new edge with start node*/

            HashMap<Node, ArrayList<Edge>> identEdgeMap = new HashMap<>();
            HashMap<Edge, Edge> newedgeToOrigedgeMap = new HashMap<>();
            /*map for indentification in thinflow-Algorithm*/
    ...
    public void runNashFlowWithMultipleSources(NashFlowProblem nashprob) throws Exception {
        ...
        while (true) {
            ...
            HashMap<Edge, Node> identMap = new HashMap<Edge, Node>();
            /*map to identify new edge with start node*/

            HashMap<Node, ArrayList<Edge>> identEdgeMap = new HashMap<Node, ArrayList<Edge>>();
            HashMap<Edge, Edge> newedgeToOrigedgeMap = new HashMap<Edge, Edge>();
            /*map for indentification in thinflow-Algorithm*/
