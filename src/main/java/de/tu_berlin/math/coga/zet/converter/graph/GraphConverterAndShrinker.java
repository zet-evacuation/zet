...
public class GraphConverterAndShrinker extends AbstractAlgorithm<BuildingPlan, NetworkFlowModel> {
    ...
    public GraphConverterAndShrinker(AbstractAlgorithm<BuildingPlan, NetworkFlowModel> converter,
            AbstractAlgorithm<NetworkFlowModel, NetworkFlowModel> shrinker) {
