...
public class ZETLoader {
     ...
     */
    private static Localization loc = GUILocalization.loc;
    /**
    ...
    /**
     * Creates the editor window and displays it on the screen. This method should be called by a scheduler, so it can
     * be executed in the event-dispatch thread. That allows to have user interaction if the program is working in other
     * threads.
     *
    ...
    public static void createEditor() {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                // Load properties
                String propertiesFile = "./properties/properties.xml";
                try {
    ...
    /**
     * Loads an xml-file containing several tasks with projects to evacuate (simulation and optimization).
     *
    ...
    /**
     * This method exits the program and prints an error message on the standard error stream. The return value is 1.
     *
    ...
    /**
     * Checks if a file exists and quits with an error message and return code 1 if not.
     *
