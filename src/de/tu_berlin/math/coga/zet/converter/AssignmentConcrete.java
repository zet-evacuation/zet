...
public final class AssignmentConcrete {
    ...
    /**
     * Creates an concrete assignment based upon the assignment areas specified in this assignment. It generates objects
     * of type Person and locates them onto RasterSquares. These squares are generated by the Rasterer class after
     * converting diagonal edges to horizontal or vertical ones. The persons will get concrete property-values according
     * to the assignment.
     *
...
//				ageCollector = lastMapping.get( room.getSquare( x, y ) );
        ...
        for (AssignmentType assignmentType : a.getAssignmentTypes()) // Gehe alle Assignment-Areas durch
        {
            for (AssignmentArea assignmentArea : assignmentType.getAssignmentAreas()) {
                ...
                for (RasterSquare s : rasterer.insideSquares()) //public RasterSquare(PlanPolygon p, int column, int row, int raster)
                {
                ...
                while (numberOfPersons > 0) {
                    ...
                    if (square.getIntersectType() == RasterSquare.FieldIntersectType.Inside) {
                        ...
                        } else //case: raster square with this location was used before but on another floor
