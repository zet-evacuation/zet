 ...
 * algorithm in its own thread by implementing {@code Runnable}. Furthermore, it
...
;
	...
	/**
	 * Returns whether log messages of this algorithm are written to System.out or
	 * not.
	...
	/**
	 * Sets the level from that messages are logged by the {@link Logger} of this
	 * algorithm. By default, messages starting from {@link Level.CONFIG} are
	 * given out using {@link System.out} and warnings and errors are sent to
	 * {@link System.err}.
	...
	/**
		...
		* current log level of the logger is below {@link Level.INFO}. Does
		* nothing otherwise.
	...
	/**
		...
		* to solve the instance using the {@link Level.SEVERE} level and re-throws
		* the runtime exception that caused the premature termination of the
