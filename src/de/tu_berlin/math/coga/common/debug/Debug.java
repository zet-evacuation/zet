...
public class Debug {
	 ...
	 * RootLogger and the global logger are removed. Then, a
	 * {@link SimpleSysoutHandler} is added as handler to the default logger. The
	 * levels of both, the logger and handler, are set to the default log level
	 * that is returned by {@link #getDefaultLogLevel() }.
	 */
