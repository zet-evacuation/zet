...
public abstract class InputFileReader<T> extends Algorithm<File,T> {
    ...
    /**
     * An enumeration type that specifies whether the reader should try to
     * optimize its runtime or its memory consumption.
     */
    ...
    /**
     * Creates a new input file reader and creates a parameter to specify an
     * optimization goal by the user. It is up to subclasses to pay heed to
     * this, though.
     */
    ...
    /**
     * Returns the optimization hint for this reader, i.e. whether memory should
     * be preserved or runtime speed. Note that this is only a hint for
     * subclasses.
    ...
    /**
     * Abstract method that returns an array of String properties with basic
     * information about the input file. The specifics depend on the
     * sub-classing reader and the file format it is for. Usually the properties
     * contain information about the size of the instance, and can be obtained
     * quickly by the reader, i.e. without parsing the whole file but only its
     * header.
