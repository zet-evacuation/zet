...
//coveredDistance
     ...
     * @param to a TimeStep
     * @return the distance which the individual has covered from TimeStep "from" to TimeStep "to"
     * @throws statistic.ca.exception.OneIndNoPotentialException
     * if the individual has no static potential (there`s no exit reachable from the individual`s position)
     * @throws statistic.ca.exception.IncorrectTimeException
    ...
    * @param from a TimeStep
    * @param to a TimeStep
     * @return the average of the individuals` covered distances from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #getCoveredDistance
    * @throws statistic.ca.exception.GroupOfIndsNoPotentialException
* if all individuals have no potential
...
public double calculateAverageCoveredDistanceForGroup(ArrayList<Individual> indgroup, int from, int to) throws GroupOfIndsNoPotentialException, IncorrectTimeException{
    ...
    * @param from a TimeStep
    * @param to a TimeStep
     * @return a list of averages of the individuals` covered distances from the TimeStep 0 to the TimeStep ("from"+i),
    * whereas i is the index of the value in the list and i runs from 0 to (to-from)
     * (this values are calculated only over those individuals which have a potential)
     * @see #getCoveredDistance
    * @throws statistic.ca.exception.GroupOfIndsNoPotentialException
* if all individuals have no potential
    * @throws statistic.ca.exception.IncorrectTimeException
...
public ArrayList<Double> calculateAverageCoveredDistanceForGroupInTimeSteps(ArrayList<Individual> indgroup, int from, int to) throws GroupOfIndsNoPotentialException, IncorrectTimeException{
     ...
     * @return the current speed the individual has in timestep t
      * @throws statistic.ca.exception.OneIndNoValueBecauseAlreadySafeException
      * if "t" is bigger than the individual`s safetyTime
     * @throws statistic.ca.exception.OneIndNoPotentialException
      * if the individual has no static potential (there`s no exit reachable from the individual`s position)
     * @throws statistic.ca.exception.IncorrectTimeException
      * if "t" is less than 0
     ...
     * (if the TimeStep "time" is later than the individual`s SafetyTime, this time is taken instead of  "time")
* @throws statistic.ca.exception.OneIndNoValueBecauseAlreadySafeException
* if the individual is already safe in timestep 1
* @throws statistic.ca.exception.OneIndNoPotentialException
* if the individual has no static potential (there`s no exit reachable from the individual`s position)
* @throws statistic.ca.exception.IncorrectTimeException
* if "time" is less or equal 0
* @throws statistic.ca.exception.MissingStoredValueException
* if the individual had no speedvalue in timestep 1
*/
...
* @param from a TimeStep
* @param to a TimeStep
* @return the average speed of the individual from the TimeStep "from" to the TimeStep "to"
* (if the TimeStep "to" is later than the individual`s SafetyTime, this time is taken instead of  "to")
* @throws statistic.ca.exception.OneIndNoValueBecauseAlreadySafeException
* if the individual is already safe in timestep "from"
* @throws statistic.ca.exception.OneIndNoPotentialException
* if the individual has no static potential (there`s no exit reachable from the individual`s position)
* @throws statistic.ca.exception.IncorrectTimeException
* if "from" is less or equal 0 OR "to" is less or equal 0 OR "from" is bigger than the original "to"
* @throws statistic.ca.exception.MissingStoredValueException
* if the individual had no speedvalue in timestep 1
*/
      ...
      /** alter Code:  
        ...
        if (!( (ind.getDeathCause() != null)  && ind.getDeathCause().compareTo(ds.ca.Individual.DeathCause.EXIT_UNREACHABLE)==0) ) {
            if (time>0) {
                ...
                return ((endCoveredDistance-startCoveredDistance)/time);
            }
            else {
               if (time==0) {
                    return 0;
                }
               else // time < 0 Zeiten falsch
                   throw new IncorrectTimeException();
            }
        }
        // Ind tot weil eingeschlossen
...
*/
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum speed of the individual from the TimeStep "from" to the TimeStep "to"
* (if the TimeStep "to" is later than the individual`s SafetyTime, this time is taken instead of  "to")
* @throws statistic.ca.exception.OneIndNoValueBecauseAlreadySafeException
* if the individual is already safe in timestep "from"
* @throws statistic.ca.exception.OneIndNoPotentialException
...
* (this value is calculated only over those individuals which have a potential and are not safe in timestep from)
* @return 0
...
*/ 
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the individuals` average-speeds from the TimeStep "from" to the TimeStep "to"
* (this value is calculated only over those individuals which have a potential and are not safe in timestep from)
* @return 0
* if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @see #calculateAverageSpeed
...
* (this value is calculated only over those individuals which have a potential and are not safe in timestep "timestep")
* @return 0
* if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @see #getCurrentSpeed
* @throws statistic.ca.exception.IncorrectTimeException
...
*/
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the individuals` maximum-speeds from the TimeStep "from" to the TimeStep "to"
* (this value is calculated only over those individuals which have a potential and are not safe in timestep from)
* @return 0
* if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @see #calculateMaxSpeed
...
public double calculateMaxSpeedForGroupInOneTimestep(ArrayList<Individual> indgroup, int timestep) throws MissingStoredValueException, GroupOfIndsNoValueBecauseAlreadySafeException, IncorrectTimeException{
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum of the individuals` maximum-speeds from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateMaxSpeed
     * @throws statistic.ca.exception.GroupOfIndsNoPotentialException if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum of the individuals` average-speeds from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateAverageSpeed
     * @throws statistic.ca.exception.GroupOfIndsNoPotentialException if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the minimum of the individuals` average-speeds from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateAverageSpeed
     * @throws statistic.ca.exception.GroupOfIndsNoPotentialException if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
  ...
  /**
     ...
     * @return 0
     * if the first stored value for the individual lies after the timestep "t"
      * @throws statistic.ca.exception.OneIndNoValueBecauseAlreadySafeException
      * if "t" is bigger than the individual`s safetyTime
     * @throws statistic.ca.exception.OneIndNoPotentialException
      * if the individual has no static potential (there`s no exit reachable from the individual`s position)
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the difference between the individual`s exhaustion in TimeStep "to" and in TimeStep "from"
     * @throws statistic.ca.exception.OneIndNoPotentialException if the individual has no static potential (there`s no exit reachable from the individual`s position)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average exhaustion of the individual from the TimeStep "from" to the TimeStep "to"
     * (if the TimeStep "to" is later than the individual`s SafetyTime, this time is taken instead of  "to")
     * @throws statistic.ca.exception.OneIndNoPotentialException if the individual has no static potential (there`s no exit reachable from the individual`s position)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 OR are in wrong order OR are both greater than the individual`s safetyTime
     */
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum exhaustion of the individual from the TimeStep "from" to the TimeStep "to"
     * (if the TimeStep "to" is later than the individual`s SafetyTime, this time is taken instead of  "to")
     * @throws statistic.ca.exception.OneIndNoPotentialException if the individual has no static potential (there`s no exit reachable from the individual`s position)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     */
     ...
     * (if the individual never had a higher exhaustion than that at the beginning of the simulation, this value is returned)
     * (if the TimeStep "to" is later than the individual`s SafetyTime, this time is taken instead of  "to")
     * @throws statistic.ca.exception.OneIndNoPotentialException if the individual has no static potential (there`s no exit reachable from the individual`s position)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     */
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the minimum exhaustion the individual had from the TimeStep "from" to the TimeStep "to" except for the exhaustion at the beginning of the simulation
     * (if the individual never had a higher exhaustion than that at the beginning of the simulation, this value is returned)
     * (if the TimeStep "to" is later than the individual`s SafetyTime, this time is taken instead of  "to")
     * @throws statistic.ca.exception.OneIndNoPotentialException if the individual has no static potential (there`s no exit reachable from the individual`s position)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
...
*/          
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the individuals` average-exhaustions from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateAverageExhaustion
     * @throws statistic.ca.exception.GroupOfIndsNoPotentialException if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the individuals` maximum-exhaustions from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateMaxExhaustion
     * @throws statistic.ca.exception.GroupOfIndsNoPotentialException if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the individuals` minimum-exhaustions from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateMinExhaustionExceptingStartExhaustion
     * @throws statistic.ca.exception.GroupOfIndsNoPotentialException if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum of the individuals` maximum-exhaustions from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateMaxExhaustion
     * @throws statistic.ca.exception.GroupOfIndsNoPotentialException if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the minimum of the individuals` average-exhaustions from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateAverageExhaustion
     * @throws statistic.ca.exception.GroupOfIndsNoPotentialException if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the minimum of the individuals` minimum-exhaustions from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateMinExhaustionExceptingStartExhaustion
     * @throws statistic.ca.exception.GroupOfIndsNoPotentialException if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the difference between the individual`s panic in TimeStep "to" and in TimeStep "from"
     * @throws statistic.ca.exception.OneIndNoPotentialException if the individual has no static potential (there`s no exit reachable from the individual`s position)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     * @throws java.lang.IllegalArgumentException
     */
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average panic of the individual from the TimeStep "from" to the TimeStep "to"
     * (if the TimeStep "to" is later than the individual`s SafetyTime, this time is taken instead of  "to")
     * @throws statistic.ca.exception.OneIndNoPotentialException if the individual has no static potential (there`s no exit reachable from the individual`s position)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 OR are in wrong order OR are both greater than the individual`s safetyTime
     */
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum panic of the individual from the TimeStep "from" to the TimeStep "to"
     * (if the TimeStep "to" is later than the individual`s SafetyTime, this time is taken instead of  "to")
     * @throws statistic.ca.exception.OneIndNoPotentialException if the individual has no static potential (there`s no exit reachable from the individual`s position)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     */
     ...
     * (if the individual never had a higher panic than that at the beginning of the simulation, this value is returned)
     * (if the TimeStep "to" is later than the individual`s SafetyTime, this time is taken instead of  "to")
     * @throws statistic.ca.exception.OneIndNoPotentialException if the individual has no static potential (there`s no exit reachable from the individual`s position)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     */
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the minimum panic the individual had from the TimeStep "from" to the TimeStep "to" except for the panic at the beginning of the simulation
     * (if the individual never had a higher panic than that at the beginning of the simulation, this value is returned)
     * (if the TimeStep "to" is later than the individual`s SafetyTime, this time is taken instead of  "to")
     * @throws statistic.ca.exception.OneIndNoPotentialException if the individual has no static potential (there`s no exit reachable from the individual`s position)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
...
*/    
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the individuals` average-panics from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateAveragePanic
     * @throws statistic.ca.exception.GroupOfIndsNoPotentialException if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the individuals` maximum-panics from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateMaxPanic
     * @throws statistic.ca.exception.GroupOfIndsNoPotentialException if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the individuals` minimum-panics from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateMinPanicExceptingStartPanic
     * @throws statistic.ca.exception.GroupOfIndsNoPotentialException if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum of the individuals` average-panics from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateAveragePanic
     * @throws statistic.ca.exception.GroupOfIndsNoPotentialException if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum of the individuals` maximum-panics from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateMaxPanic
     * @throws statistic.ca.exception.GroupOfIndsNoPotentialException if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the minimum of the individuals` average-panics from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateAveragePanic
     * @throws statistic.ca.exception.GroupOfIndsNoPotentialException if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the minimum of the individuals` minimum-panics from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #calculateMinPanicExceptingStartPanic
     * @throws statistic.ca.exception.GroupOfIndsNoPotentialException if all individuals have no static potential (there`s no exit reachable from the individuals` positions)
     * @throws statistic.ca.exception.IncorrectTimeException if the given TimeStep(s) is/are less than 0 or are in wrong order
    ...
    */
     ...
     * @see #getSafetyTime
     * @throws statistic.ca.exception.GroupOfIndsNotSafeException
      * if all individuals have no safetyTime
 */
...
*/
   ...
   * @throws statistic.ca.exception.GroupOfIndsNoPotentialException
    ...
    */
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the average of the numbers of TimeSteps in which the individuals waited from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #getWaitedTime
    * @throws statistic.ca.exception.GroupOfIndsNoPotentialException
* if all individuals have no potential
   ...
   * @throws statistic.ca.exception.GroupOfIndsNoPotentialException
    ...
    */
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the maximum of the numbers of TimeSteps in which the individuals waited from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #getWaitedTime
    * @throws statistic.ca.exception.GroupOfIndsNoPotentialException
* if all individuals have no potential
   ...
   * @throws statistic.ca.exception.GroupOfIndsNoPotentialException
    ...
    */
     ...
     * @param from a TimeStep
     * @param to a TimeStep
     * @return the minimum of the numbers of TimeSteps in which the individuals waited from the TimeStep "from" to the TimeStep "to"
     * (this value is calculated only over those individuals which have a potential)
     * @see #getWaitedTime
    * @throws statistic.ca.exception.GroupOfIndsNoPotentialException
* if all individuals have no potential
