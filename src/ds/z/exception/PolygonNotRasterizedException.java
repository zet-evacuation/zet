...
/**
 * The exception {@code PolygonNotRasterizedException} indicates that a
...
public class PolygonNotRasterizedException extends ValidationException {
	...
	/**
	 * Creates a new instance of {@code PolygonNotRasterizedException}. A {@link PlanPolygon} needs
	 * to be passed.
	...
	/**
	 * Creates a new instance of {@code PolygonNotRasterizedException} that contains the errorous {@link PlanPolygon}.
	 * @param polygon the polygon that caused this exception
