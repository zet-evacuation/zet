...
/**
 * The {@code IntegerIntegerMapping} class represents a mapping from integers to
 ...
 * {@code IntegerIntegerMapping} is considered as a step function. Consequently,
 ...
 * {@code IntegerIntegerMapping} is therefore linear in the number of steps
...
public class IntegerIntegerMapping implements Cloneable, Iterable<TimeIntegerPair> {
     ...
     * defined above. Runtime O(log (number of steps) + number of steps
     * changed).
     *
    ...
    /**
     * Adds the specified mapping to this mapping. {@code IntegerIntegerMapping}
     ...
     * {@code IntegerIntegerMapping} objects are treated as mathematical
     * functions Z -> Z for this purpose. Runtime(number of steps in
     * {@code mapping}).
     *
    ...
    /**
     * Computes the integral of this mapping. {@code IntegerIntegerMapping} is
     * considered a step function with step starts defined by its mapping for
     * this purpose. The result (a piecewise linear function) is interpreted as
     * an {@code IntegerIntegerMapping} by defining a map for each start point
     ...
     * {@code IntegerIntegerMapping}. Runtime O(1).
     *
     * @return an iterator over the time - integer mappings in this
     * {@code IntegerIntegerMapping}.
     */
    @Override
     ...
     * of type {@code IntegerIntegerMapping} and makes exactly the same
     * time - integer associations. Runtime O(number of steps).
     *
     * @param o the object to be compared with this mapping.
     * @return true if the specified object is an      {@code IntegerIntegerMapping} that is equivalent with this one,
     ...
     */
    public int minimum(int fromTime, int toTime) {
        if (fromTime > toTime) {
    ...
    /**
     * A utility class used for the underlying {@code TreeSet}. A mapping of a
     * time {@code t} to an integer value {@code v} is stored by adding a
     * {@code TimeIntegerPair (t,v)} to the tree set.
     */
    public class TimeIntegerPair implements Cloneable, Comparable<TimeIntegerPair> {
        ...
        /**
         * Constructs a new {@code TimeIntegerPair} with the specified values.
         * Runtime O(1).
         *
        ...
        /**
         * Returns the time component of this {@code TimeIntegerPair}. Runtime
         * O(1).
         *
        ...
        /**
         * Compares this {@code TimeIntegerPair} to the specified object. The
         ...
         * underlying tree set must not contain two {@code TimeIntegerPair}s
         * with the same time component. Runtime O(1).
         *
         * @param o the object this mapping is to be compared with.
         * @return {@code true} if the given object represents an
         * {@code TimeIntegerPair} equivalent to this pair, {@code false}
         * otherwise.
         */
        @Override
        public boolean equals(Object o) {
        ...
        /**
         * Returns a hash code for this {@code TimeIntegerPair}. Since this hash
         * code should be consistent with {@link #equals} just the time
         * component of the pair is used. Runtime O(1).
         *
         * @return the time component of this {@code TimeIntegerPair}.
         */
        @Override
        ...
        /**
         * Returns a string representation of this {@code TimeIntegerPair}. This
         * representation is of the form "time = value". Runtime O(1).
         *
