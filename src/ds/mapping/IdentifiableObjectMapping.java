...
/**
 * The {@code IdentifiableObjectMapping} class represents a mapping from a set
...
public class IdentifiableObjectMapping<D extends Identifiable, R> implements Cloneable {
     ...
     * order to be able to increase the length of {@code mapping} array later
     * on.
     */
     ...
     * specified initial mapping and the specified type for values. The default
     * association for an object is as specified by {@code mapping}. Runtime
     * O(1).
     *
     ...
     * @exception NullPointerException if {@code mapping} or {@code rangeType}
     * are null.
     */
    ...
    /**
     * Constructs a new {@code IdentifiableObjectMapping} object with a domain
     * of the specified size and the specified type for values. The default
     ...
     * ID is greater equal than the current size of the domain will
     * automatically increase the size of the domain to accommodate
     * {@code identifiableObject}'s ID. Runtime O(1).
     *
    ...
    /**
     * Sets the size of this mapping's domain to {@code value}. Runtime
     * O(value).
     *
     ...
     * it is associated with an object other than {@code null}. Runtime O(1).
     *
     ...
     * {@code IdentifiableObjectMapping} object which has an domain of equal
     * type and size and makes exactly the same object - value associations.
     ...
     * {@code IdentifiableObjectMapping} equivalent to this mapping,
    ...
    /**
     * Returns a hash code for this {@code IdentifiableObjectMapping}. Runtime
     ...
     * made in this mapping. Note that object - null associations will be
     * omitted in this representation. Runtime O(size of the domain).
     *
