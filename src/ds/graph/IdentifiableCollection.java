 ...
 * The {@code IdentifiableCollection} interface does not demand a 
...
public interface IdentifiableCollection<E extends Identifiable> extends Iterable<E> {
    ...
    /**
     * Adds an element to the {@code IdentifiableCollection} and returns
    ...
    /**
     * Removes the element {@code element} from the 
     * {@code IdentifiableCollection}.
    ...
    /**
     * Returns the size of this {@code IdentifiableCollection}, 
     * i.e. the number of stored elements.
     * @return the size of this {@code IdentifiableCollection}, 
     *         i.e. the number of stored elements.
     */
    int size();
    
    /**
     * Returns an element with the ID {@code id} that is stored in this 
     * {@code IdentifiableCollection}.
     ...
     * {@code IdentifiableCollection}, {@code null} if no element with this
     * ID is stored.
     */
    E get(int id);
    
    /**
     * Returns the first element stored in this {@code IdentifiableCollection}.
     * Which element is considered to be first depends on the order the concret 
     * implementation of the interface uses!
     * @return the first element stored in this {@code IdentifiableCollection},
     *         null if no element is stored.
     */
    E first();
    
    /**
     * Returns the last element stored in this {@code IdentifiableCollection}.
     * Which element is considered to be last depends on the order the concret 
     * implementation of the interface uses!
     * @return the last element stored in this {@code IdentifiableCollection},
     *        null if no element is stored.
     */
    E last();
     ...
     * {@code IdentifiableCollection} or if it is not stored in the 
     * {@code IdentifiableCollection}.
